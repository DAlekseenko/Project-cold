...
class Design extends PageComponent {
    ...
    render() {
        return (
            <Container>
                <Header h1={this.h1}/>
                <Img src={this.src} addClass={'design-img'}/>
                ...
                <Content>
                    ...
                    <h2>Проектирование вентиляции в частных домах и квартирах</h2>
                    ...
                    <p> В квартире и жилом доме разработать приточно-вытяжную систему не легче, чем для
                        ...
                        Вентиляция жилых помещений имеет свои особенности:
                        <ul>
                            ...
                            <li>Приточная вентиляция снабжается фильтрами и нагревателями.
                             <li>Приточно-вытяжные установки снабжаются рекуператорами, возвращающими тепло в помещение.</li>
                            </li>
                    ...
                    <p> Независимо от того, к какому классу относится ваш объект, мы с одинаковым
                        ...
                        обслуживание, учтивое отношение к заказчику – еще одни преимущества работы с нами. </p>
                </Content>
                <Consultation/>
            </Container>
        )
